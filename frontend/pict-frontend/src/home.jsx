...
function Home() {
  ...
  return (
    <div>
      ...
      <br></br>
      <center>
      <h1 className="mb-4 content-center text-3xl font-extrabold text-gray-900 dark:text-red md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Virtual Classroom </span> Engagement Enhancer</h1>
